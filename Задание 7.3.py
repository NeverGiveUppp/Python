...
class Cell:
    ...
    def __str__(self):
        return f'Результат вычислений: {self.cell * ".@."}'

    def __add__(self, other):
        return Cell(self.cell + other.cell)

    def __sub__(self, other):
        return self.cell - other.cell if (self.cell - other.cell) > 0 else print('Ошибка. Число не должно ровняться 0!')
    ...
    def make_order(self, rows):
        result = ''
        for _ in range(int(self.cell / rows)):
            result += f'{".@." * rows} \\n'
